...
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Database\IdentityQuery A secondary query class using the current class as primary query
     */
    public function useIdentityQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinIdentity($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Identity', '\Database\IdentityQuery');
    }
