...
use Database\ServicePeer;
use Database\map\ServiceTableMap;
...
abstract class BaseServicePeer
{
    ...
    const OM_CLASS = 'Database\\Service';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\map\\ServiceTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseServicePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\map\ServiceTableMap());
      }
    }
