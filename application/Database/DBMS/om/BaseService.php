...
/**
 * Base class that represents a row from the 'net_bazzline_identification_service_services' table.
 *
 *
 *
...
abstract class BaseService extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Application\\Database\\DBMS\\ServicePeer';
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getUpdatedAt($format = '%x')
    {
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getValidUntil($format = '%x')
    {
    ...
    public function setBaseUrl($v)
    {
        ...
        if ($this->base_url !== $v) {
            $this->base_url = $v;
            $this->modifiedColumns[] = ServicePeer::BASE_URL;
        }
    ...
    public function setToken($v)
    {
        ...
        if ($this->token !== $v) {
            $this->token = $v;
            $this->modifiedColumns[] = ServicePeer::TOKEN;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            $currentDateAsString = ($this->updated_at !== null && $tmpDt = new DateTime($this->updated_at)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
    ...
    public function setValidUntil($v)
    {
        ...
        if ($this->valid_until !== null || $dt !== null) {
            $currentDateAsString = ($this->valid_until !== null && $tmpDt = new DateTime($this->valid_until)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->valid_until = $newDateAsString;
                $this->modifiedColumns[] = ServicePeer::VALID_UNTIL;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->base_url = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->token = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->created_at = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->updated_at = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->valid_until = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = ServicePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ServicePeer::BASE_URL)) {
            $modifiedColumns[':p' . $index++]  = 'base_url';
        }
        if ($this->isColumnModified(ServicePeer::TOKEN)) {
        ...
        if ($this->isColumnModified(ServicePeer::VALID_UNTIL)) {
            $modifiedColumns[':p' . $index++]  = 'valid_until';
        }

        $sql = sprintf(
            'INSERT INTO net_bazzline_identification_service_services (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'base_url':
                        $stmt->bindValue($identifier, $this->base_url, PDO::PARAM_STR);
                        break;
                    case 'token':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getBaseUrl(),
            $keys[2] => $this->getToken(),
            $keys[3] => $this->getCreatedAt(),
            $keys[4] => $this->getUpdatedAt(),
            $keys[5] => $this->getValidUntil(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBaseUrl($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setToken($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setCreatedAt($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setUpdatedAt($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setValidUntil($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ServicePeer::BASE_URL)) $criteria->add(ServicePeer::BASE_URL, $this->base_url);
        if ($this->isColumnModified(ServicePeer::TOKEN)) $criteria->add(ServicePeer::TOKEN, $this->token);
        ...
        if ($this->isColumnModified(ServicePeer::VALID_UNTIL)) $criteria->add(ServicePeer::VALID_UNTIL, $this->valid_until);
    ...
    {
        $copyObj->setBaseUrl($this->getBaseUrl());
