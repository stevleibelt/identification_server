...
use Database\DBMS\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Database\\DBMS\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\DBMS\\map\\UserTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\DBMS\map\UserTableMap());
      }
    }
