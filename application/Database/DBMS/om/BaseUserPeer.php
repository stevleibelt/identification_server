...
use Application\Database\DBMS\map\UserTableMap;

/**
 * Base static class for performing query and update operations on the 'net_bazzline_identification_service_users' table.
 *
 *
 *
...
abstract class BaseUserPeer
{
    ...
    const TABLE_NAME = 'net_bazzline_identification_service_users';

    /** the related Propel class for this table */
    const OM_CLASS = 'Application\\Database\\DBMS\\User';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Application\\Database\\DBMS\\map\\UserTableMap';
    ...
    const ID = 'net_bazzline_identification_service_users.id';

    /** the column name for the firstName field */
    const FIRSTNAME = 'net_bazzline_identification_service_users.firstName';

    /** the column name for the lastName field */
    const LASTNAME = 'net_bazzline_identification_service_users.lastName';

    /** the column name for the email field */
    const EMAIL = 'net_bazzline_identification_service_users.email';

    /** the column name for the is_active field */
    const IS_ACTIVE = 'net_bazzline_identification_service_users.is_active';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to net_bazzline_identification_service_users
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Application\Database\DBMS\map\UserTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the net_bazzline_identification_service_users table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
