...
/**
 * Base class that represents a query for the 'net_bazzline_identification_service_users' table.
 *
 *
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Application\\Database\\DBMS\\User';
        }
    ...
    {
        $sql = 'SELECT id, firstName, lastName, email, is_active FROM net_bazzline_identification_service_users WHERE id = :p0';
        try {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Application\Database\DBMS\IdentityQuery A secondary query class using the current class as primary query
     */
    public function useIdentityQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinIdentity($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Identity', '\Application\Database\DBMS\IdentityQuery');
    }
