...
use \PropelException;
use \PropelPDO;
use Database\DBMS\Service;
use Database\DBMS\ServicePeer;
use Database\DBMS\map\ServiceTableMap;
...
abstract class BaseServicePeer
{
    ...
    const OM_CLASS = 'Database\\DBMS\\Service';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\DBMS\\map\\ServiceTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseServicePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\DBMS\map\ServiceTableMap());
      }
    }
