...
use \PropelException;
use \PropelPDO;
use Application\Database\DBMS\Service;
use Application\Database\DBMS\ServicePeer;
use Application\Database\DBMS\map\ServiceTableMap;

/**
 * Base static class for performing query and update operations on the 'net_bazzline_identification_service_services' table.
 *
 *
 *
...
abstract class BaseServicePeer
{
    ...
    const TABLE_NAME = 'net_bazzline_identification_service_services';

    /** the related Propel class for this table */
    const OM_CLASS = 'Application\\Database\\DBMS\\Service';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Application\\Database\\DBMS\\map\\ServiceTableMap';
    ...
    const ID = 'net_bazzline_identification_service_services.id';

    /** the column name for the base_url field */
    const BASE_URL = 'net_bazzline_identification_service_services.base_url';

    /** the column name for the token field */
    const TOKEN = 'net_bazzline_identification_service_services.token';

    /** the column name for the created_at field */
    const CREATED_AT = 'net_bazzline_identification_service_services.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'net_bazzline_identification_service_services.updated_at';

    /** the column name for the valid_until field */
    const VALID_UNTIL = 'net_bazzline_identification_service_services.valid_until';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'BaseUrl', 'Token', 'CreatedAt', 'UpdatedAt', 'ValidUntil', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'baseUrl', 'token', 'createdAt', 'updatedAt', 'validUntil', ),
        BasePeer::TYPE_COLNAME => array (ServicePeer::ID, ServicePeer::BASE_URL, ServicePeer::TOKEN, ServicePeer::CREATED_AT, ServicePeer::UPDATED_AT, ServicePeer::VALID_UNTIL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'BASE_URL', 'TOKEN', 'CREATED_AT', 'UPDATED_AT', 'VALID_UNTIL', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'base_url', 'token', 'created_at', 'updated_at', 'valid_until', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'BaseUrl' => 1, 'Token' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'ValidUntil' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'baseUrl' => 1, 'token' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'validUntil' => 5, ),
        BasePeer::TYPE_COLNAME => array (ServicePeer::ID => 0, ServicePeer::BASE_URL => 1, ServicePeer::TOKEN => 2, ServicePeer::CREATED_AT => 3, ServicePeer::UPDATED_AT => 4, ServicePeer::VALID_UNTIL => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'BASE_URL' => 1, 'TOKEN' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'VALID_UNTIL' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'base_url' => 1, 'token' => 2, 'created_at' => 3, 'updated_at' => 4, 'valid_until' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ServicePeer::BASE_URL);
            $criteria->addSelectColumn(ServicePeer::TOKEN);
            $criteria->addSelectColumn(ServicePeer::CREATED_AT);
            $criteria->addSelectColumn(ServicePeer::UPDATED_AT);
            $criteria->addSelectColumn(ServicePeer::VALID_UNTIL);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.base_url');
    ...
    /**
     * Method to invalidate the instance pool of all tables related to net_bazzline_identification_service_services
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseServicePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Application\Database\DBMS\map\ServiceTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the net_bazzline_identification_service_services table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
