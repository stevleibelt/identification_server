...
use Application\Database\DBMS\ServiceQuery;

/**
 * Base class that represents a query for the 'net_bazzline_identification_service_services' table.
 *
 *
 *
 ...
 * @method ServiceQuery orderByBaseUrl($order = Criteria::ASC) Order by the base_url column
 * @method ServiceQuery orderByToken($order = Criteria::ASC) Order by the token column
 ...
 * @method ServiceQuery orderByValidUntil($order = Criteria::ASC) Order by the valid_until column
 *
 * @method ServiceQuery groupById() Group by the id column
 * @method ServiceQuery groupByBaseUrl() Group by the base_url column
 * @method ServiceQuery groupByToken() Group by the token column
 ...
 * @method ServiceQuery groupByValidUntil() Group by the valid_until column
 *
 ...
 *
 * @method Service findOneByBaseUrl(string $base_url) Return the first Service filtered by the base_url column
 * @method Service findOneByToken(string $token) Return the first Service filtered by the token column
 ...
 * @method Service findOneByValidUntil(string $valid_until) Return the first Service filtered by the valid_until column
 *
 * @method array findById(string $id) Return Service objects filtered by the id column
 * @method array findByBaseUrl(string $base_url) Return Service objects filtered by the base_url column
 * @method array findByToken(string $token) Return Service objects filtered by the token column
 ...
 * @method array findByValidUntil(string $valid_until) Return Service objects filtered by the valid_until column
 *
...
abstract class BaseServiceQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Application\\Database\\DBMS\\Service';
        }
    ...
    {
        $sql = 'SELECT id, base_url, token, created_at, updated_at, valid_until FROM net_bazzline_identification_service_services WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query on the base_url column
     *
     * Example usage:
     * <code>
     * $query->filterByBaseUrl('fooValue');   // WHERE base_url = 'fooValue'
     * $query->filterByBaseUrl('%fooValue%'); // WHERE base_url LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByBaseUrl($baseUrl = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($baseUrl)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $baseUrl)) {
                $baseUrl = str_replace('*', '%', $baseUrl);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(ServicePeer::BASE_URL, $baseUrl, $comparison);
    }
    ...
    public function filterByToken($token = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ServicePeer::TOKEN, $token, $comparison);
    }
    ...
    public function filterByValidUntil($validUntil = null, $comparison = null)
    {
        if (is_array($validUntil)) {
            ...
            if (isset($validUntil['min'])) {
                $this->addUsingAlias(ServicePeer::VALID_UNTIL, $validUntil['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($validUntil['max'])) {
                $this->addUsingAlias(ServicePeer::VALID_UNTIL, $validUntil['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ServicePeer::VALID_UNTIL, $validUntil, $comparison);
    }
