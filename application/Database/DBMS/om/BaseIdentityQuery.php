...
use Application\Database\DBMS\IdentityQuery;
use Application\Database\DBMS\User;
...
abstract class BaseIdentityQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Application\\Database\\DBMS\\Identity';
        }
    ...
    {
        $sql = 'SELECT id, login, password, user_id, created_at, updated_at, valid_until FROM net_bazzline_identification_service_identities WHERE id = :p0';
        try {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Application\Database\DBMS\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\Application\Database\DBMS\UserQuery');
    }
