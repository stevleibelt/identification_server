...
class UserTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Application\\Database\\DBMS\\User');
        $this->setPackage('');
    ...
    {
        $this->addRelation('Identity', 'Application\\Database\\DBMS\\Identity', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null, 'Identitys');
    } // buildRelations()
